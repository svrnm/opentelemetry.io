...
[^shared-images]: Hugo is smart about the way that it renders image files that are shared
...
\-- this is particularly true of those contained in [layouts/\_shortcodes/docs][layouts/_shortcodes/docs].
